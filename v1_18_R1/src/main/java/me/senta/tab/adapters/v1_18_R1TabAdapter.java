/**
 * TODO find a spigot jar for 1.18 that has the actual nms classes inside.
 */
...
//import net.minecraft.server.v1_18_R1.*;
...
//import java.util.*;
//
//public class v1_18_R1TabAdapter extends TabAdapter {
//
