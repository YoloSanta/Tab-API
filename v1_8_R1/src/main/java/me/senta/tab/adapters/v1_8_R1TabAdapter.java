...
//import me.senta.tab.shared.client.ClientVersionUtil;
...
//        final int version = ClientVersionUtil.getPlayerProtocolVersion(player);
//
...
//        if (!this.initialized.contains(player)) {
//            final ChannelPipeline pipeline = this.getPlayerConnection(player).networkManager.i.pipeline();
//
//            pipeline.addBefore(
//                    "packet_handler",
//                    player.getName(),
